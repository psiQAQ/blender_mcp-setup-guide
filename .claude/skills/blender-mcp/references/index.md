...
2. [System Adaptation](./system-adaptation.md)
3. [Extension Workflow](./extension-workflow.md)
4. [Lifecycle](./lifecycle.md)
5. [Pitfalls and Fixes](./pitfalls-and-fixes.md)
6. [Migration Notes](./migration-notes.md)
